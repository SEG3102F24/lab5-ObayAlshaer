...
export class EmployeeComponent {
  ...
  onSubmit() {
    if (this.employeeForm.valid) {
      ...
      this.router.navigate(['/employees']).then(() => {}); // Navigate to employees list
    } else {
      // Optionally, you can log the errors or mark all controls as touched to show validation errors
